      ...
      <div className="flex flex-1">
        ...
        >
          <nav className="space-y-2">
            <Link href="admin/add-driver" className="block px-3 py-2 rounded-md hover:bg-gray-200 text-gray-700 font-medium">
                Add driver
            </Link>
            <a href="#" className="block px-3 py-2 rounded-md hover:bg-gray-200 text-gray-700 font-medium">
              Orders
            </a>
            <a href="#" className="block px-3 py-2 rounded-md hover:bg-gray-200 text-gray-700 font-medium">
              Users
